...
ActiveRecord::Schema[7.1].define(version: 2026_02_04_221918) do
  ...
  create_table "time_entries", force: :cascade do |t|
    ...
    t.bigint "asana_task_id"
    t.datetime "started_at", null: false
    t.datetime "stopped_at"
    t.integer "duration_seconds"
    t.text "notes"
    t.boolean "synced_to_asana", default: false
    t.string "asana_story_gid"
    t.index ["asana_project_id"], name: "index_time_entries_on_asana_project_id"
    t.index ["asana_task_id"], name: "index_time_entries_on_asana_task_id"
